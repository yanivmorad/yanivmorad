import base64, os, pickle, time, requests
import concurrent
...
class VTAnalyzer:
    ...
    def get_urls_reputation(self, urls: list,apikey="f5acf4919acd81a1e9927234b0696a2b714d8b73265f49b9e6a077207054b23a") -> dict[str, bool]:
